...
func main{
    ...
    %{  
        ...
        with open('tests/cairo_programs/fixtures/mpt_variable_key_len.json', 'r') as file:
            test_inputs = json.load(file)
            ids.batch_len = len(test_inputs)
    %}
...
func verify_n_mpt_proofs{
    ...
    %{
        ...
        print(f"key_low: {key_low}, key_high: {key_high}")
        ids.key.low = key_low
